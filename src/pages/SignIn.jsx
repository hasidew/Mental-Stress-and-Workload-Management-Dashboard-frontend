      ...
      <div className="max-w-md w-full mt-8">
        <div className="bg-white rounded-2xl p-8 shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#212121] to-gray-800 text-white py-4 px-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 font-semibold text-lg"
            >
              Sign In
            </button>
          </form>
